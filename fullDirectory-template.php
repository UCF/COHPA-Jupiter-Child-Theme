        ...
        <div style="text-align: left;" class="mk-text-block  true">
            ...
            <?php 
					...
					if(get_field('cv', 'user_' . $user->id .'')) {
							echo '<div id="directoryProfile-links"><i style="color:#c1c1c1;margin:4px;4px;" class="mk-icon-file-pdf-o  mk-size-small"></i> <a href="';
							the_field('cv', 'user_' . $user->id .'');
							echo '" target="_blank">Curriculum Vitae</a></div>';
						}
						if(get_field('website_url', 'user_' . $user->id .'')) {
							echo '<div id="directoryProfile-links"><i style="color:#c1c1c1;margin:4px;4px;" class="mk-icon-external-link  mk-size-small"></i> <a href="';
