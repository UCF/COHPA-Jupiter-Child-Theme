...
</style> <?php });// END SHORTCODE [show_research] ?> <?php add_shortcode('show_UCFannouncements', function() {
...
<?php $myannouncements = new WP_Query(array(
 ...
 <div style="margin-left:25px;"> <?php $repeater = get_field('announcement_items'); $announdate = get_sub_field('announcement_date'); $last_row = end($repeater); echo $last_row['announcement_date']; echo $last_row['announcement_item']; ?> </div> <!-- END OF THE REPEAT SECTION --> <?php endwhile; ?> <!-- END OF THE REPEAT SECTION -->	<?php /*** Shortcode: [researchlist department=""] */ function research_option($atts){
...
.mk-divider.shadow_line .divider-inner .divider-shadow-right { background-position:right center; }
.mk-image.border_shadow-frame .mk-image-inner { border:6px solid #ffffff; box-shadow:0 0 5px rgba(0, 0, 0, 0.25); } 
</style><?php	} add_shortcode( 'researchlist', 'research_option' ); ?><?php /* [internlist maincat="" subcat=""] */ function interncat( $atts ) {
...
<?php add_shortcode('show_books', function() { ?><!-- START REPEATER SECTION --><?php $mybooklist = new WP_Query(array(
...
#mk-button-2 {margin-bottom: 15px;margin-top: 0px;margin-right: 0px;}#mk-button-2 .mk-button {background-color: #ffc904;} #mk-button-2 .mk-button:hover {color:#ffffff;background-color:#222222;}#mk-button-2 .mk-button:hover .mk-svg-icon {color:#ffffff;}#divider-3 {padding:0px 0 20px;}#divider-3 .divider-inner {}#divider-3 .divider-inner:after {}</style><!-- END FORM SECTION -->	
<?php	});// END SHORTCODE [search_faculty]?>
