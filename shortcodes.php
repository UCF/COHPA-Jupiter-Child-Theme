            ...
            <div class="wpb_wrapper">
                <div id="text-block-6" class="mk-text-block   ">
                    ...
                    <p><span style="font-weight:bold; font-size:16px;">
						...
						?>
                        <div id="directoryProfile-phone"><i class="font-icon mk-size-small"><svg class="mk-svg-icon" data-name="mk-moon-phone" data-cacheid="icon-57e28d3fa68dd" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 512 512"><path d="M352 320c-32 32-32 64-64 64s-64-32-96-64-64-64-64-96l64-64s-64-128-96-128l-96 96c0 64 65.75 193.75 128 256s192 128 256 128c0 0 96-64 96-96s-96-128-128-96z"></path></svg></i> Phone: <?php the_field('phone_number', 'user_'. $user_db ); ?></div>
...
#directoryProfile-phone .font-icon svg {fill:#666666;}
</style>	
