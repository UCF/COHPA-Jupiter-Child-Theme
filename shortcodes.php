...
<?php
/**
 * Shortcode: [internlist main_intern_category=""]
 * Description: This is how stuff works with parameters
 */

function intern_option($atts){
	
	extract(shortcode_atts( array(
		'main_intern_category' => 'Legal Studies',
...
add_shortcode( 'internlist', 'cat_option' );
?>
