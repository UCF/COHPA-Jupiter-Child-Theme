...
<?php });// END SHORTCODE [show_research] ?> <?php add_shortcode('show_announcements', function() { ?><!-- START REPEATER SECTION -->	
...
?> </div> <!-- END OF THE REPEAT SECTION --> <?php endwhile; ?> <!-- END OF THE REPEAT SECTION -->	<?php	});// END SHORTCODE [show_announcements]?><?php /**Shortcode: [deptlist department=""] */ function dept_option($atts){
