            ...
            <div class="wpb_wrapper">
                <div id="text-block-6" class="mk-text-block   ">
                    ...
                    <p><span style="font-weight:bold; font-size:16px;">
						...
						?>
                        <div id="directoryProfile-email"><i style="color:#666;margin:4px;" class="mk-moon-envelop-2  mk-size-small"></i> OMG WORK: <a title="Contact <?php echo $value['display_name'] ; ?>" href="mailto:<?php the_field('email_address', 'user_'. $user_db ); ?>"><?php the_field('email_address', 'user_'. $user_db ); ?></a></div>
