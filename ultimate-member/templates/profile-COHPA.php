<?php /* Template: COHPA NEW Profile */ ?><!-- START THE CUSTOM SECTION -->
<?php
...
?><!-- START TESTING SECTION --><!-- END TESTING SECTION -->
...
<div style="padding-top: 10px; font-size: 11px; font-style: italic; line-height: 11px !important; color: #555;">*During exam week, check with the faculty member for any office-hour changes.</div>
		<?php echo '<p>&nbsp;</p></div>'; }?>		<!-- END NEW OFFICE HOURS SECTION -->    
		   	  <?php
			...
			echo '<div data-charcode="mk-icon-phone" class="mk-list-styles  mk-align-none newdirectoryspacing clear" data-family=""><ul>';		   
				if(get_field('website_url', 'user_' . $user_id .'')) {
