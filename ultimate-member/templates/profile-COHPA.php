...
<span style="font-size: 11px; font-style: italic; line-height: 11px !important;">*During exam week, check with the faculty member for any office-hour changes.</span>
		<?php echo '<p>&nbsp;</p></div>'; }?>
